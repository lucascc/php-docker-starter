...
```sh
git clone https://github.com/lucascc/php-docker-starter.git
```
...
```sh
sudo docker run --rm -v $(pwd)/app:/app composer require symfony/yaml
```

### Updating PHP dependencies with composer

```sh
sudo docker run --rm -v $(pwd)/app:/app composer update
```
